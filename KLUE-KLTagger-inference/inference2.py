...
def inference(data_dir, model_dir, output_dir, args):
    ...
    with open("C:\\Users\\kihoon\\Desktop\\KLUE-KLTagger-inference\\data\\dp-v1.1_test.tsv", "r", encoding="utf8") as f2:
        ...
        with open('C:\\Users\\kihoon\\Desktop\\KLUE-KLTagger-inference\\data\\dp-v1.1_test_mecab.json','w',encoding='utf-8') as make_file:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        help="Name of the test file (default: dp-v1.1_test.tsv)",
    )
